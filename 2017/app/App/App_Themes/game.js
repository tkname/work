$(function() {
	...
	setInterval(function() {
		$('.shang-iimg').attr('src', 'images/shou_shang.png');
		$('.xia-iimg').attr('src', 'images/shou_xia.png');
		setTimeout(function() {
			$('.shang-iimg').attr('src', 'images/shou_shang1.png');
			$('.xia-iimg').attr('src', 'images/shou_xia1.png');
		}, 300);
	}, 600);
	...
	var ballon = $("<img class = 'ballon' src='images/qiqiu.png'>");
	ballon.appendTo($('.bg'));
});