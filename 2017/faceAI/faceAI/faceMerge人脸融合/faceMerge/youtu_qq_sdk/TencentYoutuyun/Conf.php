...
class Conf
{
    ...
    public static $APPID = '10092830';
    public static $SECRET_ID = 'AKIDMbisv8FCyY4SnwJsZ4QccQ3UnCTou4va';
    public static $SECRET_KEY = 'b1GMK7iCUaYN1UlqohOtDLH1bzBB6ygD';
    public static $END_POINT = '';


    // 开发者 QQ
    public static $USER_ID = '426049918';
