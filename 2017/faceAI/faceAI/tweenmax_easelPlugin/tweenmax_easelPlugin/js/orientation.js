...
if(navigator.userAgent.indexOf('Firefox') > 0 || window.navigator.msPointerEnabled){
	...
	var adaptUILayout = (function(){
		...
		var adapt = function(uiWidth){
			...
			if(devicePixelRatio==2 && (deviceWidth==320 || deviceWidth==360 || deviceWidth==592 || deviceWidth==550)){
				deviceWidth*=2;
			}
			...
			if(devicePixelRatio==1.5 && (deviceWidth==550)){
				devicePixelRatio = 2;
			}
